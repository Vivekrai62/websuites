class OrderSearchProductResponseModel {
  String? id;
  String? productType;
  dynamic serviceType;
  String? name;
  ...
  OrderSearchProductResponseModel(
      {this.id,
      this.productType,
      this.serviceType,
      this.name,
  ...
  OrderSearchProductResponseModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
  ...
  static List<OrderSearchProductResponseModel> fromJsonList(
      List<dynamic> jsonList) {
    return jsonList
        .map((json) => OrderSearchProductResponseModel.fromJson(json))
        .toList();
  }
}
