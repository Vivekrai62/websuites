class AddProductIncentiveResponseModel {
  ...
  AddProductIncentiveResponseModel(
      {this.incentiveType,
      this.minimumSalePrice,
      this.incentive,
      this.isSale,
      this.taregtIncentive,
      this.product,
      this.id,
      this.createdAt,
      this.updatedAt});
  ...
  AddProductIncentiveResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    isSale = json['is_sale'];
    taregtIncentive = json['taregt_incentive'] != null
        ? TaregtIncentive.fromJson(json['taregt_incentive'])
        : null;
    product =
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_sale'] = isSale;
    if (taregtIncentive != null) {
      data['taregt_incentive'] = taregtIncentive!.toJson();
    }
    if (product != null) {
