...
class OrdersRecurringServicesScreen extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;
  final VoidCallback? onOrderSelected;

  const OrdersRecurringServicesScreen({
    super.key,
  ...
  @override
  _OrdersRecurringServicesScreenState createState() =>
      _OrdersRecurringServicesScreenState();
}

class _OrdersRecurringServicesScreenState
    extends State<OrdersRecurringServicesScreen> {
