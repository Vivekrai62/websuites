...
import '../../../../../../viewModels/customerScreens/activities/visit_only/customer_details_visit_only_view_model.dart';

class CustomerDetailsVisitOnlyScreen extends StatefulWidget {
  final String customerId;

  const CustomerDetailsVisitOnlyScreen({super.key, required this.customerId});

  @override
  State<CustomerDetailsVisitOnlyScreen> createState() => _CustomerDetailsVisitOnlyScreenState();
}

class _CustomerDetailsVisitOnlyScreenState extends State<CustomerDetailsVisitOnlyScreen> {
  final CustomerActivitiesVisitOnlyViewModel viewModel = Get.put(CustomerActivitiesVisitOnlyViewModel());

  @override
  void initState() {
    super.initState();
    viewModel.customerDetailsActivitiesVisitOnly(context, widget.customerId);
  }
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              ...
              Obx(() => Text(
                '${viewModel.customerVisit.length}',
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 16.5,
        ...
        Obx(() {
          ...
          final meetings = viewModel.customerVisit;
