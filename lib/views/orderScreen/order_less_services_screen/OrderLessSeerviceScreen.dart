...
class OrderLessServiceScreen extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;
  final VoidCallback? onOrderSelected;

  const OrderLessServiceScreen({
    super.key,
  ...
  @override
  _OrderLessServiceScreenState createState() => _OrderLessServiceScreenState();
}

class _OrderLessServiceScreenState extends State<OrderLessServiceScreen> {
